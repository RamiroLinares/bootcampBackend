...
app.get('/game/:movement', async (req, res) => {
    ...
    if ((_a = initBoardSquare.getPiece()) === null || _a === void 0 ? void 0 : _a.canMove(initBoardSquare, endBoardSquare)) {
        ...
        const ChessModel = (0, mongoose_1.model)('Chess', ChessSchema_1.ChessSchema);
        await (0, bookDataAccess_1.saveMovement)(ChessModel, movement).catch(err => console.log(err));
    }
    else {
